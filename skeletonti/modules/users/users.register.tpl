<!-- BEGIN: MAIN -->
      ...
      <form name="login" action="{USERS_REGISTER_SEND}" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
        ...
        <div class="form-group">
          <label class="col-lg-2 control-label">{PHP.L.users_validemail}:</label>
          <div class="col-lg-4">
        ...
        <div class="form-group">
          <label class="col-lg-2 control-label">{PHP.L.users_confirmpass}:</label>
          <div class="col-lg-4">
            {USERS_REGISTER_PASSWORDREPEAT}
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-2 control-label">{USERS_REGISTER_VERIFYIMG}:</label>
          <div class="col-lg-4">
